...
h<sub>A</sub> = 1 325 000 km,  
h<sub>П</sub> = 1 614 km,  
i = 51.5°,  
ω = 0°,  
выводимая масса = 7 300 kg, включая массу переходной системы

|*Место*|*РН*|*РБ*|*ГО*|*[НОО](nnb.md), kg*|*ГСО, kg*|*Перелёт<br> к Луне, kg*|
|:--|:--|:--|:--|:--|:--|:--|
