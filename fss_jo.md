...
Описание:
   ...
   - **Разработчик и изготовитель:** [Jena‑Optronik](03_jenaoptronik.md), EU. Разработано 2010 году. Активное применение.
...
|**`Прочее`**|• • •|
|[ВБР](rams.md) за САС|  |
|Габариты, Д×Ш×В, мм| 160 × 145 × 56  |
|Интерфейсы|  |
|Масса, кг| 0.65  |
|[Напряжение](voltage.md), В| 14 (13 ‑ 15)  |
|Перегрузки, g|  |
|[Радстойкость](ion_rad.md), Гр (рад)|   |
|Ресурс, ч (лет)|  |
|[САС](lifetime.md), ч (лет)| НОО: 113 880 (13)  |
|[Тепловой режим](tcs.md), °C| −30 ‑ +65  |
|Эл. потребление, Вт| 0.4  |
