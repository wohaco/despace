...
Примеры:
   ...
   - В системе Солнце ‑ Земля: 1 500 000 km от Земли
   - Земля ‑ Луна: 61 500 km от Луны
