...
> 2019.05.12 ┊ **🚀 [despace](index.md)** → **[Земля](earth.md)**, [Space](index.md), [Экология](ecology.md)

[TOC]

---

> <small>*Термины:* **Околоземное космическое пространство (ОКП)** — русскоязычный термин. **Near space** — англоязычный эквивалент.</small>
...
Расстояния:
   ...
   - По ОСТ 134-1022-99 — это область пространства на высотах **от 200 до 2 000 км** от поверхности Земли.
