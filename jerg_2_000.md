...
## 3. Definition of terms
   ...
   1. **[Mission Assurance](srrq.md)** — An operation action performed throughout the development & operation of spacecraft in order to ensure the mission success.
   1. **[Reliability](srrq.md)** — A property that achieves mission success within the specified mission period under the space environment.
   1. **[Safety](srrq.md)** — The property that prevents spacecrafts & its components from inflicting damage on human during the development, launch & operation of the spacecrafts & components.
