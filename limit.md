...
При разработке [КК](scs.md) обычно принимается следующее:
   ...
   - в **лимитной сводке надёжности [OE](oe.md)** также указываются предельные значения [надёжности](qm.md), *уменьшать* которые допускается только в крайних случаях с оформлением технического обоснования изменения и при согласии [главного конструктора проекта](mgmt.md).
