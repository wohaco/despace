...
**Some technical issues.** The database consists of text files with markdown. For not to be vendor‑locked. And to be able to use it anywhere in case you have a markdown editor/viewer. Notes & Requirements: (in historical order)
   ...
   1. The DB pages are supposed to be printed on the A4 pages. The proposed themes for the proposed editors (VNote, ghostwriter) renders pages in the width of A4. Arial font; sometimes Tahoma.
...
<mark>**TBD (roadmap):**</mark>

   - **MBSE**
      - PP&C Project planning & control
   - **[Vibrations and shocks](vibration.md):**
      - <https://www.google.com/search?client=ubuntu&hs=Mw9&channel=fs&ei=XUDoX7P1NqOrrgTitYX4Ag&q=grms+random+vibration&oq=Grms+rando&gs_lcp=CgZwc3ktYWIQAxgAMgQIABATMggIABAWEB4QEzoECAAQQzoCCAA6BAgAEAo6BggAEAoQEzoKCAAQFhAKEB4QE1Do3QNYxekDYKzzA2gAcAB4AIABwQGIAfMGkgEDMi41mAEAoAEBqgEHZ3dzLXdpesABAQ&sclient=psy-ab>
      ...
      - <https://www.google.com/search?client=ubuntu&hs=ZZ9&channel=fs&sxsrf=ALeKk02gdby9gomimfxR9tJX61Ofg39wYg%3A1606751176493&ei=yBPFX8rJHaqWjgbKgZPYCw&q=SINE+structural&oq=SINE+structural&gs_lcp=CgZwc3ktYWIQAzoECAAQRzoKCC4QFBCHAhCTAjoCCAA6BwgAEBQQhwI6AgguOgcILhAKEJMCOgQIABAKOgQILhAKOgYIABAWEB46CAgAEBYQChAeOggIABAIEA0QHjoECAAQDToECAAQEzoICAAQFhAeEBM6CggAEA0QBRAeEBNQ2JQIWJ-2CGCjuwhoAHACeACAAYUBiAHACJIBAzcuNJgBAKABAaoBB2d3cy13aXrIAQjAAQE&sclient=psy-ab&ved=0ahUKEwjKzffIzqrtAhUqi8MKHcrABLsQ4dUDCAw&uact=5>
   ...
   - **Оформить и добавить методики расчёта, желательно в виде программ с комментариями:**
      ...
      1. радиолинии, в т.ч. связь с Землёй, диаграммы направленности; — <mark>Писаренко</mark>
         - Orbiter ↔ Earth,
         - Orbiter ↔ Lander,
      ...
      1. топлива;
      1. технического совершенства; — <mark>Глушак</mark>
         1. антенн;
