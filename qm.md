...
ПОН оценивается по [тарифу №2](contact/lav.md).
...
**Оценка стоимости документа.**  
ПОСТ оценивается по [тарифу №2](contact/lav.md).
...
**Оценка стоимости документа.** Расчёт надёжности оценивается по [тарифу №2](contact/lav.md).
