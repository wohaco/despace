# TRL
> 2019.04.27 **[🚀](../index/index.md) [despace](index.md)** → **[OE](oe.md)**, [Качество](srrq.md), [Риск](srrq.md), [Control](control.md)

[TOC]

---

> <small>*Terms:* **Technology readiness levels (TRL, TRLs)** — English term. **Уровень готовности технологии (УГТ)** — equivalent in Russian.</small>
...
|TRL 9|**Actual system «flight proven» through successful mission operations.**<br> In almost all cases, the end of last «bug fixing» aspects of true «system development». This might include integration of new technology into an existing system. This TRL doesn’t include planned product improvement of ongoing or reusable systems.|
