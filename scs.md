...
**Производители, операторы:**
   ...
   - **India:** …
   - **Israel:** …
   - **Japan:** [Mitsubishi Elecric](zz_mitsubishi.md) — ground control stations for satellite tracking, & optical/radio telescopes for astronomical observation, antennas, transmitters & receivers
   - **Korea South:** …
