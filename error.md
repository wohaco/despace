# Типичные ошибки
> 2019.12.19 ┊ **🚀 [despace](index.md)** → [Качество](quality.md), **[НД](doc.md)**
...
## Метрология
   ...
   - В тексте документа, за исключением формул, таблиц, рисунков, не допускается:
      ...
      - применять знак «Ø» (следует писать словом диаметр);
...
| 100 кВт<br> 80 %<br> 20 °С<br> 10 Ом<br> 20°<br> 1220×740 мм<br> 5,758°  | 100кВт<br> 80 %<br> 20°С<br> 10Ом<br> 20 °<br> 1220×740мм<br> 5°758 |  |
| кПа∙с/м | Па∙кс/м |  |
...
| Диаметр крепёжных отверстий прибора должен соответствовать М 4 (4,5 мм) | Диаметр креп!жных отверстий прибора должен соответствовать М 4 (Ø 4,5) |  |
| От 1 до 5 мм<br> От 10 до 100 кг<br> От плюс 10 до минус 40 °С<br> От 8454,3 до 8464,3 МГц  | От 1 мм до 5 мм<br> 10 … 100 кг<br> +10 ‑ −40 °С<br> (8459,3 ± 5,0) МГц |  |
| Не более (если допустимы все значения меньше указанного значения).<br> Не менее (если допустимы все значения больше указанного значения).<br> Знак «±» не ставят перед не более, не менее | Больше, ниже, выше, меньше, хуже.<br> Не более ± 5 °С.<br> Не менее ± 5 °С |  |
...
|:--|:--|
| Температура точки росы °С | Точка росы |
...
| Температура минус (60 ± 5) °С | Температура – 60 °С |
| Диапазон измерений от минус 50 до плюс 200 °С | Предел измерений (−50…200) °С |
...
**Docs:**
   ...
   1. [Не делайте за других их работу ❐](f/doc/20191106_1.pdf)
