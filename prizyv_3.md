...
> <small>*Термины:* **ПРИЗЫВ‑3** — русскоязычный термин, не имеющий аналога в английском языке. **PRIZYV‑3** — дословный перевод с русского на английский.</small>
...
|Вых. мощность, Вт| 2 при КСВ ≤ 2  |
|Дальность, км| 180  |
|[Диапазон частот](rf.md), Гц| 10 000 000 (10 МГц)  |
|Нестаб. частоты|  |
|[Скорость](битрейт.md), бит/с|  |
|Структура сигнала|посылка АИМ сигнала с частотой следования импульсов 1 500 Гц в течении 0.5 ± 0.2 с с паузами между посылками 1.5 с  |
|**`Прочее`**|• • •|
|[ВБР](rams.md) за САС|   |
|Габариты, Д×Ш×В, мм|36 × 84 × 40  |
|Интерфейсы|   |
|Масса, кг| 0.17  |
...
|Эл. потребление, Вт| 1.8 для 9 В;<br> 5.4 для 27 В  |
