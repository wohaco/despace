...
*Разработчик:* [Ball A&T](03_ball_at.md), US. Разработано в 1999 году. Активное применение.
...
|Интерфейсы|   |
|Масса, кг| 7.7  |
|[Напряжение](voltage.md), В| 28 (22 ‑ 36)  |
|Перегрузки, g|   |
|[Радстойкость](ion_rad.md), Гр (рад)| до 10 000 протон/с/cm²  |
|Ресурс, ч (лет)|   |
|[САС](lifetime.md), ч (лет)| 43 800 (5)  |
