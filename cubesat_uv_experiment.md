...
> <small>**Cubesat UV Experiment (CUVE)** — EN term. **Русский** — rough RU analogue.</small>
...
**PEOPLE:**
   ...
   1. [Valeria Cottini](person.md) (UMD) — **[Principal investigator](principal_investigator.md)**
   1. Shahid Aslam (NASA/GSFC)
   1. Emiliano D'Aversa (INAF-IAPS)
   1. [Lori Glaze](person.md) (NASA/GSFC)
   1. Nicolas Gorius (CUA)
   1. Tilak Hewagama (UMD)
   1. [Nikolay Ignatiev](person.md) (IKI RAN)
