...
## Designers, manufacturers
   ...
   - **Korea South:** …
   - **Russia:** …
      1. SPS of an SC is produced by everyone who produces SC ([VNIIEM](zz_vniiem.md), [ISS](zz_iss_r.md), [LAV](zz_lav.md), etc.)
      1. SPS sub‑item — see the corresponding sub‑item from the list above
      1. [AVEKS](zz_aveks.md)
   - **Saudi Arabia:** …
   - **Singapore:** …
   - **USA:** …
