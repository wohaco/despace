...
> <small>*Термины:* **Ротор** — русскоязычный термин. **Rotor** — англоязычный эквивалент.</small>

**Ротор** — вращающееся инерциальное устройство, применяемое для:

   1. запасания и последующей выдачи электрической энергии; (см. [СЭС](sps.md))
   2. обеспечения спуска в атмосфере. (см. [ПУС](lag.md))



## Описание
По принципу работы аналогичен [двигателю‑маховику](rw.md), только не является управляющим.
