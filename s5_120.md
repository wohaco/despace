...
> <small>**С5.120** — русскоязычный термин, не имеющий аналога в английском языке. **S5.120** — дословный перевод с русского на английский.</small>

**С5.120** — 2‑компонентный [двигатель](ps.md) производства [КБХМ](zz_kbhm.md).

Характеристики указаны для вакуума и номинальных условий работы в непрерывном режиме. Режим работы считать установившимся со 2‑й секунды подачи напряжения на электроклапаны.

|*Characteristics*|*[Value](si.md)<br> (С5.120)*|
|:--|:--|
|Composition| |
|Consumption, W| |
|Dimensions, ㎜|820 × 440|
...
|Fuel: consumption, ㎏/s, ≤|1.967213115|
...
|Thrust: nominal, N (kgf)|5 886 (600)|
...
**Notes:**
   ...
   1. **[1]** — экспертная оценка.
   1. **Applicability:** «Аргон» («Зенит‑6У») ┊ проект для РБ «Курьер» (1998 год)
