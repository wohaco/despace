...
**Варианты названия.**  
Надо учесть общие тенденции НПОЛ при названии платформ *(Двина‑ТМ, Карат, Навигатор, Фрегат)*.
   1. Квартердек
   1. Лунагрузик
   1. Баржа́
...
|Манёвр увода  |  большая  |  94  |
   ...
   - [ПУ](lag.md) на ЛГ имеет массу 21 кг (магний), на ЛР1 — 32 кг (магний), на ЛГМ‑Фрегат — 100 кг.<mark>TBD</mark>
   - [ПНУ](lag.md) на ЛР1 — 27 кг <mark>TBD</mark>, на ЛГМ‑Фрегат — 80 кг <mark>TBD</mark>
   - Если летим на ЭРДУ, то необходимо вытормозить скорость около 3 000 м/с; при этом время полёта будет около 90 суток.
   - Если летим через точки либрации, то скорость на перелёте будет около 100 м/с.
...
Примечания:
   ...
   - ПН входит в атмосферу Луны на скорости 11 км/с.
...
**Опции:**
   ...
   1. СББ с ЭРДУ. Применяется 1 [СПД-230](spd_230.md) и 4 [СПД-70](spd_70.md), суммарным электропотреблением 16 400 Вт, то есть нужны БС площадью ~ 65 m². За счёт малой тяги орбита будет сильно спиральной, скорость, которую надо будет затормозить, равна ~ 3 500 м/с (за счёт формы орбиты, длительности торможения, влияния Земли и Луны), что примерно соответствует разнице в уд. импульсах между ЖРДУ и ЭРДУ. Таким образом, по предварительным оценкам ЭРДУ не обеспечит выгоды в массе КА.
