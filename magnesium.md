...
Кларк магния — 1.95 % (19.5 kg/т). Это один из самых распространённых элементов земной коры. Большие количества магния находятся в морской воде в виде раствора солей.
...
|Плотность (при [н.у.](sctp.md))|1,738 g/cm³|
...
Плотность магния при 20 ℃ — 1.738 g/cm³, температура плавления 650 ℃, температура кипения 1 090 ℃, теплопроводность при 20 ℃ — 156 Вт/(м·К).
