...
**iQPS Inc.** (Institute for Q-shu Pioneers of Space Inc.) is a JP company aimed to capture radar imagery of Earth every 10 minutes — a “real‑time Google Maps” — by building a constellation of a small (~ 100 kg) SAR ([Synthetic Aperture Radar](sar.md)) sats. Thus to measure a weather even at nighttime. Founded 2005.06.

Management:  
CEO — Shunsuke Onishi.  
COO — Toshimitsu Ichiki.
...
|*Date*|*Description*|
|:--|:--|
|2019|Succesful launch of QPS small SAR sat “IZANAGI” from Satish Dawan Space Center in India.|
...
*Tech.* iQPS Inc’s highly-acclaimed technological strengths & development capabilities.
   ...
   - *Feature.*  Small SAR sats enable near real-time observations of the Earth.
      ...
      - <small>SAR realizes day-and-night & weather-independent observation. To solve this problem, SAR technology drew our attention. However, existing SAR sats generally weigh 1 000  ‑ 2 000 kg & thus require huge antenna & a significant amount of electricity. In addition, in order to fully cover the skies, a large number of sats need to be launched, which requires enormous cost & effort.</small>
      - <small>World 1st high-res small SAR sat weighing 100 kg. To overcome the hurdles of electricity & antenna size, we developed a large but storable lightweight antenna. We realized an innovation that is far beyond the ordinary level, & which can reduce the weight to 100 kg, 1/20th that of existing sats, & the cost to around 1/100th of conventional ones, while achieving 1 m res. This is the 1st high-res small SAR sat in the world weighing 100 kg.</small>
