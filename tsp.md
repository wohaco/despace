...
| | |
|:--|:--|
|[![](f/sgm/tsp-01_thumb.webp)](f/sgm/tsp-01.png)|ТСП в разрезе:<br> 1 — обшивка;<br> 2 — плёночный клей (например, ВК-41);<br> 3 — [тепловая труба](hp.md);<br> 4 — сотопласт (например, фольга АМг 2-Н-0.03);<br> 5 — самовспенивающийся клей;<br> 6 — закладной элемент.|
|[![](f/sgm/tsp-02_thumb.webp)](f/sgm/tsp-02.png)|Общий вид ТСП с тепловыми трубами.|
