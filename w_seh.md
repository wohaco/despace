...
|TBD|Technical part:<br> ・Bots — to perform robotic and routine duties, accept commands, remind, & track states<br> ・Chat (Matrix) or Mattermost or Rocket.chat — to communicate<br> ・Git (Gitea, GitLab) — to store them all with history & backups<br> ・Markdown — to collaboratively write, parse, & remember everything<br> ・Office apps (Word, Excel) — because they look nice, have an ability to create math models, & everyone have them|
...
|TBD|Proper non-scientific books to read:<br> ・Antoine de Saint-Exupéry — Le Petit Prince<br> ・Clifford D. Simak — City<br> ・Isaac Asimov — anything (especially the Foundation series)<br> ・Stanisław Lem — Solaris<br> ・Strugatsky — anything<br> ・Sun Tzu — The Art of War<br> ・Arthur C. Clarke. — Childhood's End|
