...
|:--|:--|:--|
|**Астроном.<br> длины**|1 астрон. единица (а.е.)|149 597 870.691 ㎞ = ~ 150 млн ㎞ = 0.000004848 парсека|
...
### Радиация
   ...
   - 1 кулон/килограмм (Кл/㎏) = 3 876 R — доза фотонного излучения, образующего ионы с зарядом в 1 ед. заряда СГСЭ ((1/3)×10⁻⁹ кулон) в 1 ㎝² воздуха
   - 1 рентген (R) = 0.000257976 Кл/㎏ — неСИ
