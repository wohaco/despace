...
### Расстояние
   - 1 km = 1 000 м = 100 000 см = 1 000 000 мм
...
|:--|:--|:--|
|**Астроном.<br> длины**|1 астрон. единица (а.е.)|149 597 870.691 km = ~ 150 млн km = 4.848·10⁻⁶ парсека|
||1 [парсек](parsec.md) (пк)|206 264.8 а.е. = 3.0856776·10¹⁶ м = 30.8568 трлн km (петаметров) = 3.2616 светового года|
||1 световой год|9 460 730 472 580 820 м = ~ 9.5 трлн km (петаметров) = 63 241.1 а.е. = 0.306 601 парсек|
|**Длины**|1 верста|1.0668 km|
||1 дюйм (")|2.54 см|
||1 кабельтов|182.88 м = 185.2 м (междунар.) = 185.3184 м (англ.) = 219.456 м (старый США)|
||1 лига|4.828032 km|
||1 лье|4.445 km (сухопутное) = 5.565 km (морское) = 3.898 km (почтовое)|
||1 миля|1.609344 km (англ./амер.) = 1.852 km (морская)|
||1 фут|30.48 см|
||1 ярд|0.9144 м|
...
### Радиация
   - 1 Гр = 100 рад — поглощённая энергия в 1 Дж на 1 kg массы вещества
...
|*Вид*|*Наименование*|*Размер*|
|:--|:--|:--|
|**Объём жидкости**|1 л|1.76 пинты = 0.23 галлона = 0.001 m³|
|**Англ. внесист.**|1 баррель|0.16365 m³ (для сыпучих веществ)|
||1 бушель|36.36872 литров = 8 галлонов = 0.0363687 m³ (междунар. коробка 18 kg)|
||1 kgарта|2 пинты = 1/4 галлона = 1.23 л|
||1 пинта|0.57 л|
||1 галлон|8 пинт = 4.55 л (Имперский галлон)|
||1 унция|2.841·10⁻⁵ m³|
|**Американ. внесист.**|1 амер. галлон|3.785 л (распространён в США)|
||1 унция|2.957·10⁻⁵ m³|
|**Античные внесист.**|Котила|0.275 л|
|**Древне-еврейские**|Эйфа|24 883 cm² (Эйфа́)|
||Омер|0.1 эйфы|
||Гин|4147 cm²|
||Кав|1382 cm²|
|**Русские внесист.**|Бочка|40 вёдер = 492 л|
...
### Силы
   ...
   - **Килограмм‑сила** *(кгс или кГ)* равна силе, сообщающей телу массой один килограмм [ускорение 9.80665 m/s²](g.md). Килограмм‑сила ≈ силе, с которой тело массой 1 kg давит на весы на поверхности Земли (примерно, т.к. вес немного зависит от широты, т.к. от неё зависит ускорение силы тяжести *g* ввиду не шарообразной формы Земли, которое имеет разное значение на полюсах и экваторе).
...
|*Силы*|*Размер*|
|:--|:--|
|1 [атм](atmosphere.md) (атм, atm, ата)|101 325 Па ≈ 101 кПа = 760 мм рт ст = 10 332.275649687 кгс/m² = 1.033227453 kgf/cm² = 10 м глубины океана|
|1 атм техн. (ат, at, kgf/cm², ати)|98 066.5 Па|
|1 kgс|9.80665 ньютонов (Н)|
|100 kgс/m²|≈ 1 кПа = 1 кН/m²|
|1 л.с.|75 kgс·м/с|
|1 Н|≈ 0.10197162 kgс = 1 kg·м/с²|



### Скорости

   - **Скорость света** — абсолютная величина скорости распространения электромагнитных волн в вакууме. 299 792 458 m/s ≈ 300 000 km/s = 1 079 252 848.8 km/h = 173 а.е./день.
...
**Заправка:**
   ...
   - **Расход топлива:**
      ...
      - **Ещё вариант.** `Mt = Mstart·(1 − e^(−V/(g·Isp)))` — массы в кг, время в с, импульс в с (кгс).
