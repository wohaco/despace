...
**Payload Definition Document (PDD)** — the document used by [ESA](contact/esa.md) during the [R&D](rnd.md) process which contains a description, requirements & characteristics of scientific tasks of the mission & payload, as well as an analysis of the possibility of implementing the mission with this payload.
