...
**Применение:**  
Конструкционный асботекстолит предназначается для изготовления тормозных фрикционныx механизмов, изготовления деталей механического сцепления, прокладок, в качестве теплоизоляционного материала. Допустимая рабочая температура материала от −40 до +130 °С. Теплостойкость в пределах: от +225 до +250 °С.
