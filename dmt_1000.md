...
|*Characteristics*|*[Value](si.md)<br> (ДМТ-1000)*|
|:--|:--|
|Composition| |
|Consumption, W| |
|Dimensions, ㎜| |
...
|Pressure: comb. chamber, ㎫ (kgf/㎝²)|4 (40) **⁽¹⁾**|
|Pressure: engine entrance, ㎫ (kgf/㎝²)|7 (70) **⁽¹⁾**|
|Pressure: nozzle cut, ㎫ (kgf/㎝²)| |
|Resourse: fuel, ㎏, ≥|10|
|Resource: number of thrusts, ≥|1 000 **⁽¹⁾**|
|Resource: total thrust (duration), s, ≥|30 **⁽¹⁾**|
|Resource: total impulse, N·s (kgf·s), ≥| |
|Resource: total thrust, N (kgf), ≥|30 000 (3 050)|
|Temperature: comb. chamber, К (℃)| |
|Temperature: nozzle cut, К (℃)| |
|Thrust: deviation, N (kgf)| |
|Thrust: [Isp](isp.md), N·s/㎏ (s), ≥|2 756 (281) **⁽¹⁾**|
|Thrust: max. duration of one thrust, s|0.035 ‑ 3 **⁽¹⁾**|
|Thrust: max. switching frequency, ㎐| |
|Thrust: nominal, N (kgf)|1 000 (102) **⁽¹⁾**|
