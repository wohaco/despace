...
|**[Временные зоны](timezone.md)**|=|**Timezones**|
|**[Время](time.md)**|=|**Time**|
...
|**СКЗ** — спектральный класс звёзд (см. [Звезда](звезда.md)) |=|**Stellar classification**|
...
||•·· **DSN** — [deep space network](deep_space_network.md) |≠|**СГК** — сеть глубокого космоса |
...
||•·· **MCO** — [Mars climate orbiter](mars_climate_orbiter.md) |≠|**МКО** — Макс климат орбитер |
