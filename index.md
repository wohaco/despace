...
|**B**|**[Blender](blender.md)**|Блендер|
| |**Blue paper**|Синяя книга (see [Цветные книги](colour_papers.md))|
|**C**|**[C](c.md)**|Си|
...
| |**CEO** — chief executive officer (see [Management](mgmt.md))|Генеральный директор|
| |**CET** — central European time (see [Time](time.md))|Средне‑европейское время. MSK+1 летом, MSK+2 зимой|
| |**CML** — concept maturity levels|**УЗК** — [уровни зрелости концепта](cml.md)|
| |**CONOPS** — [concept of operations](conops.md)|Концепция эксплуатации|
| |**Cold gas**|Азот|
| |**COO** — chief operating officer (see [Management](mgmt.md))|Главный инженер|
| |**[Cosmographia](cosmographia.md)**|≠ Космография|
| |**COSPAR ID / International designator / NSSDC ID** (see [SpaceID](spaceid.md))|Номер полёта|
| |**CTO** — chief technical officer (see [Management](mgmt.md))|Главный инженер; технический директор|
|**D**|**DEM** — [digital elevation model](digital_elev_model.md)|≠ **ЦМР** — цифровая модель рельефа|
| |**Don’t Panic!**|≠ [Без паники](faq.md)|
| |**[DOORS](doors.md)**|≠ ДОРС|
...
| |**DSN** — [NASA deep space network](dsn.md)|≠ **DSN** — сеть дальней космической связи НАСА|
...
| |**Flagship Mission** (see [ТЭО](fs.md))|Флагманская миссия|
| |**FLPP** — [future launchers preparatory programme](flpp.md)|≠ **FLPP** — программа разработки перспективных пусковых установок|
| |**FR** — frequency reuse (see [Comms](comms.md))|= Повторное использование частот|
| |**FSS** — [fixed‑satellite service](sc_comm.md)|= **ФСС** — фиксированная спутниковая служба|
...
| |**HTS** — [high-throughput satellite](sc_comm.md)|≠ **ВПС** — высокопроизводительный спутник|
|**I**|**I/F** — [interface](interface.md)| |
| |**ICD** — [interface control document](interface.md)| |
| |**IDSN** — [Indian deep space network](idsn.md)|≠ **IDSN** — индийская сеть дальней космической связи|
| |**IRD** — [interface requirement document](interface.md)| |
| |**Ing**|**ИПТ** — [импульс последействия](ing.md)|
...
| |**NFPA 704** ​— [standard system for the identification of the hazards of materials for emergency response](nfpa_704.md)​ ​|**NFPA 704** ​— стандарт по определению степени опасности материалов ​|
| |**NGO** ​— need, goals, objectives (see [R&D](rnd.md))|≠ НГО ​— цель, вопросы, задачи|
...
| |**NSSDC ID / COSPAR ID / International designator** (see [SpaceID](spaceid.md))|Номер полёта (see [SpaceID](spaceid.md))|
| |**NTRS** ​— NASA Technical Reports Server (see [NASA STI](nasa_sti.md))|≠ **СТОН** ​— сервер технических отчётов НАСА|
...
| |**[Paper size](paper_size.md)**|Формат бумаги|
...
| |**SCN** — satellite catalog number (see [SpaceID](spaceid.md))|Номер по спутниковому каталогу (see [SpaceID](spaceid.md))|
...
| |**STL** — [Systems Tool Kit](systems_tool_kit.md)|≠ **СТЛ** — набор системных инструментов|
...
|**T**|**[TALOS](talos.md)** — thruster advancement for low‑temperature operation in space|≠ **ТАЛОС** — улучшения двигателей для низкотемпературной работы в космосе|
| |**TBA** — to be announced|≠ Требуется объявить|
| |**TBC** — to be confirmed​|≠ Требуется подтвердить|
| |**TBD** — to be determined|≠ Требуется определить|
| |**Team X** (see [JPL IF](jpl_if.md))|≠ Команда Икс|
| |**[Teamcenter](teamcenter.md)** (PLM‑система)|≠ Тимцентр|
| |**[Tennis racket theorem](tr_theorem.md), Dzhanibekov effect**|Эффект Джанибекова|
| |**TMI** — trans‑Mars injection|[Выход на орбиту Марса](nnb.md#tmi)|
| |**[Tradespace](tradespace.md)**|Определение границ|
| |**TTC** — telemetry tracking command| |
|**U**|**UDSC** — [Usuda deep space center](udsc.md)|≠ **UDSC** — центр дальней космической связи Усуда|
...
| |**White paper**|Белая книга (see [Цветные книги](colour_papers.md))|
...
| |**Yellow paper**|Жёлтая книга (see [Цветные книги](colour_papers.md))|
...
| |*Ru*|*En*|
|:--|:--|:--|
|**А**|**АБ** — аккумуляторная батарея (see [ХИТ](eb.md))|**RB** — rechargeable battery / storage battery / secondary cell / accumulator|
| |**АВПКО** — [анализ видов, последствий и критичности отказов](fmeca.md)|**FMECA** — failure modes effects criticality analysis|
| |**АВПО** — анализ видов и последствий отказов (see [АВПКО](fmeca.md))|**FMECA** — failure modes effects criticality analysis|
| |**АВН** — [авторский надзор](des_spv.md)|Designer’s supervision|
| |**АД** — астродатчик (see [ЗД](sensor.md))|**ST** — star tracker|
| |**АЕ** — астрономическая единица (see [СИ и формулы](si.md))|**AU** — astronomical unit|
| |**АИ** — [автономные испытания](аи.md)|Component test|
| |**АКА** — автоматический космический аппарат (see [КА](sc.md))|**SC** — spacecraft|
| |**АКС** — авиационно‑космическая система (see [КА](sc.md))|Aerospace system|
...
| |**АОЛС** — атмосферная оптическая линия связи (see [ЛКС](fso.md))|**FSO** — [free‑space optics](fso.md)|
...
| |**АСН** — автономная система навигации (see [САН](ans.md))|**ANS** — autonomous navigation system|
...
| |**БА КИС** — бортовая аппаратура командно‑измерительной системы (see [Радиосвязь](comms.md))|≠ **C&MSOE** — command & measurement system onboard equipment|
| |**БАК** — блок автоматики и коммутации (see [БАС](eas.md))|≠ **ACUC** — commutation & automatic control unit|
...
| |**БВК** — бортовой вычислительный комплекс (see [ЦВМ](obc.md))|Computer|
...
| |**Белая книга** (see [Цветные книги](colour_papers.md))|White paper|
| |**[Бережливое производство](lean_man.md)**|Lean manufacturing / Lean production|
| |**БИБ** — бесплатформенный инерциальный блок (see [Гироскоп](iu.md))|≠ **SDIRU** — strap down inertial reference unit|
| |**БИВК** — бортовой информационный вычислительный комплекс (see [ЦВМ](obc.md))|Computer|
...
| |**БКНА** — бортовой комплекс научной аппаратуры (see [OE](sc.md))|**PL** — payload|
...
| |**БОКЗ** — блок определения координат звёзд (see [ЗД](sensor.md))|**ST** — star tracker|
| |**[Болото](swamp.md)**|Swamp|
| |**Бритва Оккама** (see [FAQ](faq.md))|Occam’s razor|
...
| |**БРС** — бортовые системы (see [OE](sc.md))|**OE** — onboard equipment|
| |**БРСП** — блок распределения силового питания|≠ **PSDU** — power supply distribution unit|
| |**БРТК** — бортовой радиотехнический комплекс (see [Радиосвязь](comms.md))|[Communications / Comms](comms.md)|
...
| |**БУНИ** — блок управления научной информацией (see [БУ](eas.md))|≠ **SDCM** — scientific data control module|
| |**БУст** — [буровая установка](буст.md) (see [ГЗУ](sss.md))|**DR** — drilling rig|
| |**БУС** — блок усилителя сигнала|≠ **SAMM** — signal amplifier module|
| |**БФ** — батарея фотоэлектрическая (see [БС](sp.md))|**SC** — solar cell|
| |**БФК** — блок формирования кодов|≠ **CSHU** — code shaping unit|
| |**БЦ** — [баллистический центр](scs.md)|**BAC** — ballistic analysis center|
| |**БЦВМ** — бортовая цифровая вычислительная машина (see [ЦВМ](obc.md))|Computer|
| |**БЦВК** — бортовой центральный вычислительный комплекс (see [ЦВМ](obc.md))|Computer|
| |**БШВ** — бортовая шкала времении (see [Время](time.md))|≠ Onboard timescale / Onboard timeline|
| |**БЭ** — блок электроники|**ELMO** — electronics module|
| |**БЭК** — [безэховая камера](ach.md)|**ACH** — anechoic chamber|
| |**БЭКГ** — безэховая газовая камера (see [БЭК](ach.md))|**ACHG** — anechoic gas chamber|
|**В**|**ВА** — возвращаемый аппарат (see [СхД](draft_model.md))|**REVE** — reentry vehicle / return vehicle|
| |**[Валидация](val_ver.md)**|Validation|
| |**[ВБР](qm.md)** — вероятность безотказной работы|Reliability|
| |**ВБУ КТ** — внутрибаковое устройство капиллярного типа (see [КЗУ](cinu.md))|≠ **CITD** — capillary innertank device|
...
| |**ВГ** — ветрогенератор (see [ВЭУ](wt.md))|**WT** — wind turbine|
...
| |**ВД** — видимый диапазон (see [Диапазоны частот](rf.md))|**VS** — visible spectrum|
| |**ВЕД** — [ведомость документации](liod.md)|≠ **LIOD** — list of documentation|
| |**[Ведомство](agency.md)**|≈ Agency|
| |**[Венера](venus.md)**|Venus|
| |**[Верификация](val_ver.md)**|Verification|
| |**[Вето](veto.md)**|Veto|
| |**ВДМ** — [вибродинамическая модель](vd_model.md)|≠ Vibrodynamic model|
| |**ВЗВ** — [видимая звёздная величина](app_mag.md)|Apparent magnitude|
| |**ВЗЧ** — высокоэнергетичные заряженные частицы (see [КЛ](космические_лучи.md))|**HECP** — high‑energy charged particles|
| |**ВИ** — видео информация|**VIN** — video information|
| |**ВИРК** — высокоинформативный радиокомплекс (see [Радиосвязь](comms.md))|≠ **HIRC** — high‑informative radiocomplex|
...
| |**ВОГ** — волоконно‑оптический гироскоп (see [Гироскоп](iu.md))|**FOG** — fibre optic gyroscope|
| |**ВОЛП** — [волоконно‑оптическая линия передачи](ofts.md)|**OFTS** — optical fiber transmission system|
| |**ВОЛС** — волоконно‑оптическая линия связи (see [ВОЛП](ofts.md))|**OFTS** — optical fiber transmission system|
| |**ВП** — [военное представительство](milro.md)|**MILRO** — military representative office|
| |**ВП МО РФ** — военное представительство министерства обороны РФ (see [ВП](milro.md))|≠ **MODR MILRO** — Ministry of Defence of the Russian Federation military representative office|
| |**ВПЗУ** — воспроизведение запоминающегося устройства (see [ЗУ](ds.md))|≠ **DSPB** — data storage playback|
| |**[Временные зоны](time.md)**|Timezones|
| |**[Время](time.md)**|Time|
| |**ВРЛ** — высокоинформативная радиолиния (see [Радиосвязь](comms.md))|≠ **HIRL** — high‑informative radioline|
...
| |**ВУ** — внешние условия (see [ВВФ](ef.md))|External conditions|
...
| |**ВЭП** — высокоэнергетические протоны (see [КЛ](cr.md))|**FPT** — fast protons|
...
| |**ГЗК** — грунтозаборный комплекс (see [ГЗУ](sss.md))|**SSS** — soil sampling system|
| |**ГЗУ** — [грунтозаборное устройство](sss.md)|**SSS** — soil sampling system|
| |**Гиродин** (see [ДМ](iu.md))|**CMG** — control moment gyroscope|
| |**[Гироскоп](iu.md)**|**Gyroscope** / **IMU** — inertial measurement unit|
| |**Гиростабилизатор** (see [Гироскоп](iu.md))|**IMU** — inertial measurement unit|
| |**ГИВУС** — гироскопический измеритель вектора угловой скорости (see [Гироскоп](iu.md))|**ARS** — angular rate sensor|
| |**ГИС** — главная измерительная система|≠ **MAMS** — major measurement system|
| |**ГК** — генеральный конструктор|≠ General designer|
| |**ГК, ГСК** — государственный контракт (see [Договор](contract.md))|Public contract|
| |**ГКЛ** — галактические космические лучи (see [КЛ](cr.md))|**GCR** — galactic cosmic rays|
...
| |**ГЛК** — главный конструктор (see [Руководство ОКР](mgmt.md))|≠ Chief designer|
...
| |**ГНИО** — (see [ГНИО РКП](hrorsi.md))|≠ **HRORSI** — head research organization of the Russian space industry|
...
| |**ГТ** — главный технолог (see [Руководство ОКР](mgmt.md))|**CPE** — chief process engineer|
| |**Гусь** (see [FAQ](faq.md))|**Goose** (see [FAQ](faq.md))|
...
| |**ДБК** — двигательный блок коррекции (see [ДУ](ps.md))|≠ **COEA** — corrections engine assembly|
| |**ДБС** — двигательный блок стабилизации (see [ДУ](ps.md))|≠ **STEA** — stabilizations engine assembly|
| |**ДВУ** — долгота восходящего узла|**LOAN** — longitude of the ascending node|
| |**ДГ** — директивный график (see [ док. планирования](plan.md))|Milestones|
| |**ДДА** — датчик давления аналоговый|**ANPS** — analogue pressure sensor|
| |**ДЕК** — день качества|Quality day|
| |**ДЕК** — дно качества (see [FAQ](faq.md))|≠ Quantity day|
...
| |**ДИЗВ** — дополнительное извещение (see [ИИ](ch_notice.md))|Additional change notice|
| |**ДИСД** — доплеровский измеритель скорости и дальности (see [ИСР](doppler.md))|Doppler|
| |**ДК** — двигатель коррекции (see [ДУ](ps.md))|≠ **CEN** — correction engine|
| |**ДКА** — дальний космический аппарат|≠ **LDSC** — long-distance spacecraft|
| |**ДМ** — [двигатель‑маховик](iu.md)|**RW** — reaction wheel|
| |**ДМВ** — декретное московское время (see [Временные зоны](time.md))|≠ Decree Moscow time|
| |**ДМТ** — двигатель малой тяги (see [ДУ](ps.md))|**LTEN** — low thrust engine|
...
| |**ДОК** — дорожная карта (see [ док. планирования](plan.md))|Roadmap|
...
| |**ДСП** — для служебного пользования (see [Секретность](confident.md))|Confidential / For official use only|
| |**ДСТ** — двигатель стабилизации (see [ДУ](ps.md))|**STEN** — stabilization engine|
...
| |**ЕСП** — единый сквозной план (see [документ планирования](plan.md))|≠ **UEEP** — United end-to-end plan|
...
| |**Журнал изменений** (see [ИИ](ch_notice.md))|Change notice|
| |**ЖЦИ** — [жизненный цикл изделия](pl.md)|**PL** — product lifecycle (see PLM)|
...
| |**Зелёная книга** (see [Цветные книги](colour_papers.md))|Green paper|
...
| |**ИИ КП** — ионизирующее излучение космического пространства (see [ИИЗ](ion_rad.md))|**OSIRA** — outer space ionizing radiation|
| |**ИИЗ** — [ионизирующее излучение](ion_rad.md)|**IRA** — ionizing radiation|
| |**ИИИ** — источник ионизирующего излучения (see [ИИЗ](ion_rad.md))|**IRSO** — ionizing radiation source|
...
| |**Информативность** (see [Битрейт](bitrate.md))|≠ [Bitrate](bitrate.md)|
...
|**К**|**КА** — комический аппарат (see [FAQ](faq.md))|≠ …|
...
| |**КАС** — комплекс автоматики и стабилизации (see [БАС](eas.md))|≠ **ERACU** — electric regulation & automatic control unit|
| |[QA](qm.md)|Quality|
| |**КБ** — конструкторское бюро|≠ Design studio / Drawing office|
| |**КБУст** — каротажно‑буровая установка (see [БУст](буст.md))|**DR** — drilling rig|
...
| |**КК** — комический комплекс (see [FAQ](faq.md))|≠ …|
...
| |**КЛУВЭ** — космические лучи ультравысоких энергий (see [КЛ](cr.md))|≠ **UHECR** — ultra‑high energy cosmic rays|
...
| |**КНА** — комплекс научной аппаратуры (see [OE](sc.md))|**PL** — payload|
...
| |**КОБ** — космический объект (see [АОБ](aob.md))|[Astronomical object](aob.md) / Celestial object|
| |**КОИ** — конструкторско‑отработочные испытания|≠ Development-performed tests|
| |**[Командировка](business_travel.md)**|Business travel|
| |**Компетентность** (see [Компетенция](competence.md))|Competence|
...
| |**Конструкция** (see [SGM](sc.md))|Structures|
...
| |**КС** — космическая система (see [КК](scs.md))|≠ Space systems|
...
| |**КЦА** — комплекс целевой аппаратуры (see [OE](sc.md))|**PL** — payload|
...
| |*Ru*|*En*|
|:--|:--|:--|
|**Л**|**ЛВВ** — лазерный высотомер‑вертикант (see [ИСР](doppler.md))|**LA&RS** — laser altimeter & roll stabilizer|
| |**ЛВС** — локальная вычислительная сеть|**LAN** — local area network|
| |**ЛЗ** — лист запуска (see [ИИ](ch_notice.md))|Change notice|
...
| |**ЛКИ** — лётные комплексные испытания (see [ЛИ](rnd_e.md))|Phase E|
...
| |**МК** — менеджер по качеству (see [Руководство ОКР](mgmt.md))|Quality assurance manager|
| |**МКА** — многоразовый космический аппарат (see [КА](sc.md))|Re‑entry space vehicle|
| |**МКВ** — менеджмент качества|**QM** — quality management|
| |**МКИО** — мультиплексный канал информационного обмена (see [МКО](mil_std_1553.md))|[MIL-STD-1553](mil_std_1553.md)|
| |**МКО** — [мультиплексный канал обмена](mil_std_1553.md)|[MIL-STD-1553](mil_std_1553.md)|
| |**МКС** — многоразовая космическая система (see [КК](scs.md))|≠ Reusable space system|
| |**МКУ** — матричная команда управления|≠ Matrix steering signal|
| |**МКТС** — многоразовая космическая транспортная система (see [КА](sc.md))|Reusable space transport system|
...
| |**МНА** — малонаправленная антенна (see [Антенна](antenna.md))|**LGA** — low gain antenna|
...
| |**Мозговой штурм** (see [Совещание](meeting.md))|Brainstorming|
| |**МПИ** — магистральный параллельный интерфейс (see [МКО](mil_std_1553.md))|[MIL-STD-1553](mil_std_1553.md)|
...
| |**МТКС** — многоразовая транспортная космическая система (see [КА](sc.md))|Reusable space transport system|
...
| |**МЭ** — [электромонтажный чертёж](draft_model.md)|Electric assembly drawing|
...
|**Н**|**НА** — научная аппаратура (see [OE](sc.md))|**PL** — [payload](sc.md)|
...
| |**Начальник** (see [Руководитель](manager.md))|Executive / Manager|
...
| |**НДСХ** — низкочастотная динамическая схема (НДСа, ㎝. [ВДМ](vd_model.md))|≠ Low frequency dynamic design|
...
| |**Несущая частота** (see [Несущий сигнал](carrwave.md))|Carrier wave / Carrier signal / Carrier|
...
| |**ННК** — неземной научный комплекс (see [FAQ](faq.md))|≠ payload data unearthly segment|
| |**[Nautilus-X](nautilus_x.md)**|≠ Наутилус‑Икс|
| |**Номер по спутниковому каталогу** (see [SpaceID](spaceid.md))|**SCN** — satellite catalog number (see [SpaceID](spaceid.md))|
| |**Номер полёта** (see [SpaceID](spaceid.md))|International designator / COSPAR ID / NSSDC ID (see [SpaceID](spaceid.md))|
| |**[Номинал](nominal.md)**|Nominal|
| |**Номинальное напряжение** (see [Напряжение](voltage.md))|Nominal voltage|
| |**НОО** — [низкая опорная орбита](nnb.md)|**LEO** — [low Earth orbit](nnb.md)|
| |**Нормальные условия** (see [СУТД](sctp.md))|**SCTP** — standard conditions for temperature & pressure|
| |**Нормо‑час** (see [Оценка стоимости работ](zz_lav.md))|Standard hour|
...
| |**НСПИ** — наземная станция приёма информации (see [НС](scs.md))|≠ Ground station for information reception|
| |**НСПНИ** — наземная станция приёма научной информации (see [НС](scs.md))|≠ Ground station for scientific information reception|
| |**Нст** — нестабилизированное напряжение (see [Напряжение](voltage.md))|Unregulated voltage|
| |**НСУ** — наземная станция управления (see [НС](scs.md))|Ground control station|
...
| |**НТП** — научно‑техническая продукция (see [НТД](st_act.md))|R&D deliverables|
...
| |**НТУ** — научно‑технические услуги (see [НТД](st_act.md))|Scientific & technical service|
...
| |**ОКР** — опытно‑конструкторская работа (see [R&D](rnd.md))|**R&D** — research & development|
| |**ОМ** — орбитальный модуль|Orbiter|
| |**ОМИ** — обработанная метеорологическая информация|≠ Worked meteorological information|
| |**ОНА** — остронаправленная антенна (see [Антенна](antenna.md))|**HGA** — high gain antenna|
...
| |**ПИ** — [патентные исследования](patent_res.md)|Patent research|
...
| |**пк** — парсек (see [СИ и формулы](si.md))|**PC** — parsec|
| |**ПК** — программа качества|Quality program / Quality plan|
| |**ПКА** — пилотируемый космический аппарат (see [КА](sc.md))|**MSC** — manned spacecraft|
| |**ПкИ** — программа качества|Quality program / Quality plan|
| |**ПКК** — пилотируемый космический корабль (see [ПКА](sc.md))|**MSC** — manned spacecraft|
...
| |**ПЛЗ** — планетарная защита (see [Экология](ecology.md))|**PP** — planetary protection|
...
| |**ПОБ** — программа обеспечения безопасности (see [Безопасность](qm.md))|Safety assurance program|
...
| |**ПОН** — программа обеспечения надёжности (see [Надёжность](qm.md))|Safety assurance program|
...
| |**ПОСТ** — программа обеспечения стойкости (see [Надёжность](qm.md))|≠ Resistibility assurance program|
...
| |**ПП** — план‑проспект выпуска (see [ док. планирования](plan.md))|Phase development plan|
...
| |**Протокол** (see [Совещание](meeting.md))|Protocol|
...
| |**ПУСМ** — посадочное устройство сминаемое (see [ПУС](пуc.md))|≠ **LAGS** — squash landing gear|
| |**ПУСН** — посадочное устройство надувное (see [ПУС](пуc.md))|≠ **LAGP** — pneumatic landing gear|
| |**ПУСТ** — посадочное устройство торовое (see [ПУС](пуc.md))|≠ **LAGT** — torus landing gear|
...
| |**Радиация** (see [ИИЗ](ion_rad.md))|Radiation|
...
| |**РБФ** — разгонный блок «Фрегат» (see [НПОЛ ИП](zz_lav.md))|Fregat|
...
| |**РД** — рабочая документация (see [Док‑ты](doc.md))|Operational documentation|
| |**РДТТ** — [ракетный двигатель твёрдого топлива](spr.md)|**SPR** — solid-propellant rocket|
| |**[Резерв](reserve.md)**|Reserve|
| |**Резервирование** (see [Надёжность](qm.md))|Redundancy|
...
| |**[Риск](qm.md)**|Risk|
| |**РИТ** — радионуклидный источник тепла (see [РИТЭГ](rtg.md))|**RHU** — radioisotope heater unit|
| |**РИТЭГ** — [радионуклидный изотопный термоэлектрический генератор](rtg.md)|**RTG** — [radioisotope thermoelectric generator](rtg.md)|
| |**РК** — радикомплекс (see [Радиосвязь](comms.md))|[Communications / Comms](comms.md)|
...
| |**РКДОК** — рабочая конструкторская документация (see [КД](doc.md))|≠ Operational design documentation|
...
| |**РЛК** — радиолокационный комплекс (see [РЛС](рлс.md))|Position-radar station|
...
| |**РНИ** — расчёт надёжности|Reliability prediction|
| |**РНЛК** — ракета‑носитель лёгкого класса ([см. РН](lv.md))|**SSLV** — standard small launch vehicle (LV)|
| |**РНСК** — ракета‑носитель среднего класса ([см. РН](lv.md))|**MLV** — medium launch vehicle (LV)|
| |**РНСЛК** — ракета‑носитель сверхлёгкого класса ([см. РН](lv.md))|**ULLV** — ultralight launch vehicle (LV)|
| |**РНСТК** — ракета‑носитель сверхтяжёлого класса ([см. РН](lv.md))|**SHLV** — super‑heavy launch vehicle (LV)|
| |**РНТК** — ракета‑носитель тяжёлого класса ([см. РН](lv.md))|**HLV** — heavy launch vehicle (LV)|
| |**РНТД** — результаты научно‑технической деятельности (see [НТД](st_act.md))|R&D deliverables|
...
| |**РПР** — руководитель проекта (see [Руководство ОКР](mgmt.md))|Project supervisor|
...
| |**РУ** — радиопередающее устройство (see [БРК](comms.md))|[Communications / Comms](comms.md)|
| |**РУ ПНИ** — радиоустройство передачи научной информации (see [БРК](comms.md))|[Communications / Comms](comms.md)|
...
|**С**|**С** — секретно (see [Секретность](confident.md))|Secret / Confidential|
...
| |**СБ** — солнечная батарея (устар., ㎝. [БС](sp.md))|**SP** — solar panel|
...
| |**[Сборочный чертёж](draft_model.md)**|Assembly drawing|
...
| |**СВЧ** — сверхвысокие частоты (see [Диапазоны частот](rf.md))|**SHF** — super‑high frequencies / microwaves|
| |**СВЧД** — сверхвысокочастотный диапазон радиоволн (see [Диапазоны частот](rf.md))|**SHF** — super‑high frequencies / microwaves|
...
| |**СДП** — солнечный датчик положения (see [СД](sensor.md))|**SS** — sun sensor|
...
| |**Сидерический период** (see [Астропериоды](astroperiod.md))|Sidereal period|
...
| |**Синяя книга** (see [Цветные книги](colour_papers.md))|Blue paper|
...
| |**СКЗ** — спектральный класс звёзд (see [Звезда](aob.md))|Stellar classification|
| |**СКЛ** — солнечные космические лучи (see [КЛ](cr.md))|Solar cosmic ray|
...
| |**СН** — стабилизированное напряжение (see [Напряжение](voltage.md))|Regulated voltage|
| |**СНА** — средненаправленная антенна (see [Антенна](antenna.md))|**MGA** — medium gain antenna|
...
| |**СОВ** — систематическая ошибка выжившего (see [Типичные ошибки](error.md))|**SB** — survivorship bias (or survival bias)|
...
| |**Спутник** (see [КА](sc.md))|Satellite|
...
| |**СС** — совершенно секретно (see [Секретность](confident.md))|Top secret / Highly classified|
...
| |**СТР** — система терморегулирования (see [СОТР](tcs.md))|**STC** — spacecraft thermal control|
...
| |**СхД** — [схема деления](draft_model.md)|≈ **WBS** — work breakdown structure|
| |**[Схема](doc.md)**|Diagram / Chart|
| |**[Схема осцилляторов](draft_model.md)**|Oscillator circuit|
| |**[Схема полей зрения](draft_model.md)**|≠ Field of view draft|
| |**СхЧ** — [схема членения](draft_model.md)|≠ Unit decomposition diagram|
| |**СхЭ** — [схема электрическая](draft_model.md)|Electrical interconnect diagram|
...
| |**СЭ** — солнечный элемент (see [ФЭП](sp.md))|**SP** — solar panel|
| |**СЭА** — [система электроавтоматики](eas.md)|≠ Electro-automatic system|
| |**СЭК** — система эксплуатации|≠ System of production activity|
| |**СЭП** — система электропитания (see [СЭС](sps.md))|**SPS** — power system / spacecraft power system|
...
| |**ТДД** — трудовой договор (see [Договор](contract.md))|Employment contract|
...
| |**[Типографика](typography.md)**|Typography|
...
| |**ТОП** — [техническое описание](specification.md)|Specification|
...
| |**ТЧ** — [теоретический чертёж](draft_model.md)|Sheer drawing|
...
| |**ТЭМХ** — термоэлектрический модуль холодильный (see [Элемент Пельтье](элемент_пельтье.md))|**TEC** — thermoelectric cooler|
...
| |**УДМ** — управляющий двигатель‑маховик (see [ДМ](iu.md))|**CMG** — control moment gyroscope|
| |**[Узел орбиты](nnb.md)**|Orbital node|
| |**УЗК** — [уровни зрелости концепта](cml.md)|**CML** — concept maturity levels|
| |**УЗУ** — [уровни зрелости управления](mml.md)|**MML** — [modeling maturity mevels](mml.md)|
...
| |**УКВ** — ультракороткие волны (see [Диапазоны частот](rf.md))|**VHF** — very high frequency|
...
| |**УЧ** — [упаковочный чертёж](draft_model.md)|≈ Packing drawing|
...
| |**ФКПР** — федеральная космическая программа России (see [ФКП](fed_sp.md))|≠ Federal Space Program|
...
|**Х**|**ХИТ** — [химический источник тока](eb.md)|**EB** — [electric battery](eb.md)|
| |**Хмель** — единица фильтрации оппонента (see [СИ](si.md))|≠ **Hmel** — base unit of opponent filtration|
| |**ХРИП** — [хранение, разработка, исследования, планирование](adra.md)|≠ **ADRA** — archives, development, research, administration|
| |┕|≈ **PC** — primary cell|
|**Ц**|**ЦА** — целевая аппаратура (see [OE](sc.md))|**PL** — payload|
...
| |**ЦМ** — центр масс (see [МИХ](mic.md))|**GoM** — center of mass|
...
| |**ЦТ** — центр тяжести (see [МИХ](mic.md))|**CoG** — center of gravity|
...
| |**Человеко‑час** (see [Оценка стоимости работ](zz_lav.md))|Man‑hour / Person‑hour|
| |**ЧОВ** — [чертёж общего вида](draft_model.md)|≈ **TD** — technical drawing (drafting / drawing)|
| |・ **[Чибис‑М](чибис_м.md)** (…)|≠ **Chibis-M** (…)|
|**Ш**|**ШВ** — шкала времени (see [Время](time.md))|Timescale / Timeline|
| |**ШИ** — штатное изделие (see [ШО](flight_unit.md))|≠ Flight unit|
| |**ШО** — [штатный образец](flight_unit.md)|≠ Flight unit|
| |**ШР** — широкополосный режим|**BBM** — broadband mode|
|**Э**|**ЭВМ** — электронная вычислительная машина (see [ЦВМ](obc.md))|Computer|
...
| |**ЭКБВТ** — электронная компонентная база высокотемпературная (see [ЭКБ](elc.md))|**HTEC** — high temperature electronic components (ElC)|
| |**ЭКБЭУ** — электронная компонентная база для экстремальных условий (see [ЭКБ](elc.md))|**EEEC** — extreme environment electronic components|
...
| |**ЭМ** — электронный модуль (see [ЭКБ](elc.md))|Electronic unit|
...
| |**ЭРИ** — электрорадиоизделия (see [ЭКБ](elc.md))|**EC** — electronic components (ElC)|
| |**ЭРД** — [электроракетный двигатель](epsp.md)|**EPSP** — electrically-powered spacecraft propulsion|
...
| |**Этапы ОКР** (see [R&D](rnd.md))|**R&D** — research & development|
...
|**Я**|**ЯР** — [ядерный реактор](nr.md)|**NR** — nuclear reactor|
| |**ЯРДУ** — [ядерная ракетная двигательная установка](ntr.md)|**NTR** — nuclear thermal rocket|
| |**ЯЭДУ** — ядерная электродвигательная установка|**NER** — nuclear electric rocket|
