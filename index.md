...
## Glossary (EN)
Here is the common terminology & abbreviation for the space sector with the EN‑RU conversions. There is almost no abbreviations for [organizations](contact.md), payload & terms within a single project. Approximate number of EN‑RU terms: **1 174** × 2. <small>*(Note. How to count: a number of lines − 49 − 27×9)*</small>
...
||•·· **FLPP** — [future launchers preparatory programme](flpp.md) |≠ **ППБП** — подготовительная программа для будущих пусков |
...
|**СКПМТТ** — система контроля параметров метеорно‑техногенных тел |≠ **System for control of meteor-technogenic objects characterictics**|
...
|:--|:--|
|![](f/px310.png)|![](f/px310.png)|
|**УАККиС** — Управление автоматическими космическими комплексами и системами |≠ **AOASS** — Administration of automatic spacesystems |
...
|**УРи** — [управление рисками](risk.md) |= **RMAS** — [risk management, assessment system](risk.md) / **CRM** — continuous risk management |
...
|:--|:--|
|![](f/px310.png)|![](f/px310.png)|
|**[Фактор автобуса](bus_factor.md)**|= **[Bus factor](bus_factor.md)**|
...
|:--|:--|
|![](f/px310.png)|![](f/px310.png)|
|**ХИТ** — [химический источник тока](eb.md) |= **EB** — [electric battery](eb.md) |
...
|:--|:--|
|![](f/px310.png)|![](f/px310.png)|
|**ЦА** — целевая аппаратура (см. [OE](oe.md)) |= **PL** — payload |
...
|:--|:--|
|![](f/px310.png)|![](f/px310.png)|
|**ЧаВо** — [частые вопросы](dont_panic.md) |= **FAQ** — [frequently asked questions](dont_panic.md) |
...
|:--|:--|
|![](f/px310.png)|![](f/px310.png)|
|**ШВ** — шкала времени (см. [Время](time.md)) |= **Timescale / Timeline**|
...
|:--|:--|
|![](f/px310.png)|![](f/px310.png)|
|**ЯР** — [ядерный реактор](nr.md) |= **NR** — nuclear reactor |
