# despace
> 2020.02.25 **[🚀](../index/index.md) [despace](index.md)** → [despace](index.md)
...
## Glossary
Here is the common terminology & abbreviation for the space sector with the EN‑RU conversions. There is almost no abbreviations for [organizations](contact.md), payload & terms within a single project. Approx. number of EN‑RU terms: **1 174** × 2. <small>*(Note. How to count: a number of lines − 49 − 27×9)*</small>. **Marks:**
...
|**A**|**A‑Team** (см. [JPL IF](jpl_if.md))|≠ **Команда А**|
...
|**[Руководство ОКР](rnd_mgmt.md)**|= **R&D management**|
...
|:--|:--|
|![](f/px310.png)|![](f/px310.png)|
|**С** — секретно (см. [Секретность](confident.md))|= **Secret / Confidential**|
...
|**СЭ** — солнечный элемент (см. [ФЭП](solar_cell.md))|= **SP** — solar panel|
...
|:--|:--|
|![](f/px310.png)|![](f/px310.png)|
|**ТА** — [тепловой аккумулятор](heat_bank.md)|= **SH** — storage heater|
...
|**ТН** — [точка Немо](point_nemo.md)|= **PN** — [point Nemo](point_nemo.md)|
...
||**ФЭП** — [фотоэлектрический преобразователь](solar_cell.md)|= **SC** — solar cell|
