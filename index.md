...
Here is the common terminology & abbreviation for the space sector with the EN‑RU conversions. There are almost no abbreviations for [organizations](contact.md), payload & terms within a single project. Marks:
   ...
   - **=** En & Ru terms have a total match;
...
|**M**|**MML** — [modeling maturity mevels](mmlevels.md)|= **УЗУ** — [уровни зрелости управления](mml.md)|
...
||**кгс** — килограмм‑сила (см. [СИ, формулы](si.md))|= **kgf** — kg-force|
...
|**М**|**[Магнитометр](sensor.md)**|= **MAG** — [magnetometer](sensor.md)|
