...
|  |Температура: камера сгорания гидразинового ЖРД всего 1 000 °C. В принципе уже возможно взлететь с ПМ.  |Всё равно придётся закрывать всё под собой экраном, пусть и не из вольфрама.  |
