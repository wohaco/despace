...
||Простота операции.|Необходимость установки мощных пружин, способных подбросить на 10‑20 м ВМ массой 500 kg.|
...
||Экономия массы топлива ≈ 10 kg.|Возможно, что струи ДУ ВМ перевернут ПМ.|
...
Датчики давления предлагается использовать с измерением от 0 до 25 kgf/cm².
...
**Итого**, предлагается следующее:
   ...
   1. В состав ЗУ входят 2 полукомплекта памяти (6 × 128 кбайт), процессор, опрашивающий датчики и записывающий информацию, трансформатор, БКС, корпус; общая масса не более 1 kg;
