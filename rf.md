...
|**ДМВ / UHF**|en. *ultra high frequency*|0.3 ‑ 3|10 ‑ 100|Дециметровые волны.<br> • 1 420.40575 МГц, 21.1 см — нейтральный водород.|
|**L**|en. *Long*|1 ‑ 2|15 ‑ 30||
...
**Сверхвысокие частоты (СВЧ)** — этот термин может означать:
   ...
   - диапазон частот микроволнового излучения — 300 МГц ‑ 300 ГГц;
   - диапазон частот сантиметровых волн — 3 ‑ 30 ГГц.
