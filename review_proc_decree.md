...
> 2019.04.09 ┊ **🚀 [despace](index.md)** → **[Док‑ты](doc.md)**
...
Решение о порядке защиты оценивается по [тарифу №2](03_lav.md).
...
**Docs:**
   ...
   1. Решение о порядке защиты. [Шаблон ❐](f/doc/review_procedure_decree_blank.doc).
