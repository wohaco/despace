...
|3. Acquire temporal meteorological data to guide global circulation models ([EVN‑011](venus.md))|Measurement of P, T, wind speed (u), wind direction (v), and light|
|4. Estimate the momentum exchange between the planet and its atmosphere ([EVN‑041](venus.md))|Measurement of P, T, wind speed (u), wind direction (v), and light|
