...
> 2019.05.12 ┊ **🚀 [despace](index.md)** → [Док.](doc.md), **[Test](test.md)**

[TOC]

---

> <small>*Термины:* **Перечень методик испытаний (ПМИ)** — русскоязычный термин, не имеющий аналога в английском языке. **List of test procedures** — дословный перевод с русского на английский.</small>
...
Разрабатывается на этапе [ЭП](rnd_ep.md) на основании требований [Положения РК‑11‑КТ](const_rk11.md) п.3.1.5.
...
Перечень методик испытаний оценивается по [тарифу №2](03_lav.md).
...
**Docs:**
   ...
   1. Перечень методик испытаний. [Шаблон ❐](f/doc/perechen_metodik_ispytaniy_template.doc). [Пример ❐](f/doc/perechen_metodik_ispytaniy_sample.pdf).
