...
**Двигательная установка (ДУ) космического аппарата** — система [КА](sc.md), обеспечивающая его ускорение. Предназначена для: ➀ создания импульсов тяги при проведении активных манёвров КА и посадки; ➁ создания реактивных управляющих моментов вокруг трёх осей КА с целью ориентации и стабилизации КА, успокоения КА после отделения от [РБ](lv.md), построения солнечной ориентации и стабилизации КА в СО, стабилизации КА при разгрузке [ДМ](iu.md) и проведении активных манёвров.
