...
**Служебная записка (СЗ)** — основной документ, с помощью которого осуществляется формальное общение между подразделениями НПОЛ.
   - СЗ пишется обычно от имени начальника комплекса на имя начальника другого комплекса(ов). В редких случаях возможно написание СЗ от имени начальника отдела, но лучше так не делать.
   - СЗ пересылается через ЭДО.
   - СЗ отличается от докладной и объяснительной тем, что в СЗ обычно просят от адресата принятия каких‑либо действий или мер по урегулированию возникшей проблемы.
