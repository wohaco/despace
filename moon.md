# Луна
> 2019.03.21 ┊ **🚀 [despace](index.md)** → [Space](index.md), **[Moon](moon.md)**
...
|[Inclination](keplerian.md) (i)| 5.145° (относительно эклиптики) |
|Orbital velocity (v)| 1.023 км/с (средняя) |
...
|**Physics:**|—|
|[1st escape velocity](esc_vel.md) (v₁)| 1.68 км/с <small>(0.212 земной)</small> |
|[2nd escape velocity](esc_vel.md) (v₂)| 2.38 км/с <small>(0.212 земной)</small> |
...
|Volume (V)| 2.1958·10¹⁰ km³ <small>(0.020 земного)</small> |
...
|[Surface gravity](g.md)| 1.62 м/с² (экватор, <small>0.165 земного</small>) |
...
|Радиация|  |
|Температура| Мин. 100 К (−173 °C);<br> Ср. 220 К (−53 °C);<br> Макс. 390 К (117 °C);<br> на экваторе Мин. 33 К (−240 °C);<br> на экваторе Ср. 130 К (−143 °C);<br> на экваторе Макс. 230 К (−43 °C) |
...
|EMN‑047||Surface: what can be said about the structure & composition of the surface of different regions according to Venus's evolution.|  |C|||||
...
|EMN‑031||Atmosphere: long-term variations of the meteocharacterictics on the surface.|  ||D||||
...
|EMN‑097||Atmosphere: the effect of solar radiation & interplanetary space on the atmo.|  ||D|F|||
...
**Docs:**
   ...
   1. [Модели грунта ❐](f/aob/moon/moon_soil_model.7z)
