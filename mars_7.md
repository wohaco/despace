...
*Разработчик:* [МОКБ Марс](03_mars_mokb.md). Разработано в рамках ОКР <mark>TBD</mark> в <mark>TBD</mark> году. 
   - **Предшественник:** 
   - **Преемник:** 
...
| Разрядность данных  |  |
| Тип процессора  |2 × 50 МГц;<br> первый выполняет функции ЦП, второй — функции ввода‑вывода  |
|**Etc:**|• • •|
|[ВБР](rams.md) за САС|   |
