...
|Структура сигнала| |
|**Etc:**|• • •|
|[ВБР](qa.md) за САС|0.9392|
|Габариты, Д×Ш×В, ㎜|230 × 154 × 45|
|Интерфейсы|Customizable LVDS. Two ports with 4 pairs each (clock input/output, data, optional enable). RS-422 or [MIL-STD-1553](mil_std_1553.md)|
|Mass, kg|1.8|
