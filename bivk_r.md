...
Разработчик [НТЦ Модуль](zz_ntc_module.md). Разработано в рамках ОКР «[Luna‑25](луна_25.md)» в 2015 году. активное использование. Заимств. с КА «[Luna‑25](луна_25.md)». (по состоянию на 17.06.2017)
...
|Volume, ㎅|4 096 — ОЗУ (с кодом Хемминга)<br> 8 192 — ЭППЗУ<br> 32 — защищённой памяти|

**Notes:**

   1. Не может работать на [нестабилизированной шине](voltage.md) в связи со входом в циклическую перезагрузку.
   1. **Applicability:** [Венера‑Д](венера‑д.md)・ [Luna‑25](луна_25.md)・ [Луна‑26](луна_26.md)・ [Luna‑27](луна_27.md)
