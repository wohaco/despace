...
| Хим. формула  |H₂O₂  |
|**`Физические свойства`**  |—|
| Кинематическая вязкость  |1.245 cm²/с  (при 20 °C)  |
...
| Температура горения  |500 ‑ 1 000 °C  |
...
В качестве **однокомпонентного топлива** применяется 70 ‑ 99 % раствор H₂O₂, который подаётся на катализатор (обычно, серебро или платина), разлагается на кислород и перегретый пар с температурой 500 ‑ 1 000 °C и с [удельным импульсом](isp.md) 161 ‑ 210 с.
