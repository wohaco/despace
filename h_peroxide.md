...
|[Токсичность](nfpa_704.md)|нетоксичен|
|Хим. формула|H₂O₂|
|**【Физические свойства】**|—|
...
|Temper. — comb. chamber, К (℃)|500 ‑ 1 000 ℃|
...
Применяется как ракетное топливо, в качестве окислителя или как однокомпонентное (с разложением на катализаторе), в том числе для привода [турбонасосных агрегатов](turbopump.md). Является одним из двух (второй — [Гидразин](hydrazine.md)) однокомпонентных топлив, не считая газов, которые нашли распространение в космической технике.
