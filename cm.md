# Блок управления
> 2019.05.12 ┊ **🚀 [despace](index.md)** → [OE](oe.md), [GNC](gnc.md), **[БУ](sp.md)**, [СЭА](ea_sys.md), [Control](control.md)

[TOC]

---

> <small>*Термины:* **Блок управления (БУ)** — русскоязычный термин. **Control module (CM)** — англоязычный эквивалент.</small>
...
|**`Блок управления (БУ):`**<br> …<br>• • •<br> **РФ:** [АС18Р](ас18р.md) |
