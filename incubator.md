...
Ниже приведена **аналитическая сводка** состояния космической отрасли в мире, а также перспективные проекты, находящиеся в **инкубаторе НПОЛ**.
...
|2020.02.10| **[Баумана, ПУСМ с краш-опорами ❐](f/lag/lags_2020baumana.pdf).**<br> Сминаемые опоры без направляющих. На момент помещения в инкубатор технология имела TRL 1 и была диссертационным проектом Луковкина Романа и его руководителя [Г.А. Щеглова](02_scheglov_001.md). |
