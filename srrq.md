...
|:--|:--|
|<small>• [Авторский надзор](des_spv.md);<br> • [АВПКО](fmeca.md);<br> • [Вероятность безотказной работы (ВБР)](srrq.md);</small>|<small>• [Ионизирующее излучение](ion_rad.md);<br> • [Критичные элементы](sens_elem.md);</small>|
