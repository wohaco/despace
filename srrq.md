...
**Безопа́сность** — отсутствие какого‑либо [риска](srrq.md), в случае реализации которого возникают негативные последствия (вред) в отношении кого‑либо или чего‑либо.
...
|:--|:--|
|<small>• [Авторский надзор](des_spv.md);<br> • [АВПКО](fmenca.md);<br> • [Вероятность безотказной работы (ВБР)](srrq.md);</small>|<small>• [Ионизирующее излучение](ion_rad.md);<br> • [Критичные элементы](sens_elem.md);</small>|
